  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center text-white px-6 max-w-3xl mx-auto pb-[22vh]">
        ...
        >
          El campo colombiano,{' '}
          <span className="text-kimeru-naranja">ahora con voz propia</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-lg md:text-xl text-white/85 mb-10 leading-relaxed drop-shadow"
        >
        ...
        >
          <Button href="#quienes-somos" variant="primary" className="text-base px-8 py-4">
            Conoce Kimeru
          </Button>
        </motion.div>
      </div>
