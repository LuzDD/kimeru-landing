...
export default function HeroParallax() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-3xl mx-auto pb-[10vh] md:pb-[22vh]">
        <motion.div
          initial={{ opacity: 0, y: 16 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.6 }}
          className="bg-white/35 backdrop-blur-md border border-white/50 rounded-3xl px-5 py-8 md:px-12 md:py-12 shadow-2xl"
        >
          <motion.h1
            initial={{ opacity: 0, y: 24 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.6, delay: 0.1 }}
            className="text-3xl md:text-6xl font-bold leading-tight mb-4 md:mb-6 text-kimeru-verde-profundo drop-shadow-sm"
          >
            El campo colombiano,{' '}
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-gray-800 mb-7 md:mb-10 leading-relaxed"
          >
